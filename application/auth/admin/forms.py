...
class LineForm(FlaskForm):
    ...
    choice1 = StringField('Choice 1', validators=[DataRequired(), Length(min=2), Length(max=100)])
    choice2 = StringField('Choice 2', validators=[DataRequired(), Length(min=2), Length(max=100)])
    choice3 = StringField('Choice 3', validators=[DataRequired(), Length(min=2), Length(max=100)])
